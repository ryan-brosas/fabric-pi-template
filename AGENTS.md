...
- `node --version` — confirm `>=24` (Fabric 0.24.3 peer dep).
...
`ee0bb190...`, the imported value, version-coupled to pi-fabric 0.24.3) before launching the untrusted
